...
<body class="bg-white">
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            <div class="text-center mb-16">
                <div class="inline-flex items-center gap-2 border border-gray-200 bg-gray-50 px-4 py-2 mb-6">
                    ...
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-600">Why Choose iOS</span>
                </div>
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 font-display tracking-tight">
                    Why Choose <span class="text-gray-400">iOS</span>
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6 text-center">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">Premium Users</h3>
                ...
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6 text-center">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">Higher Security</h3>
                ...
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6 text-center">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">Better Performance</h3>
    ...
    <!-- App Types We Build - With Images -->
    <section class="py-20 md:py-28 bg-gray-50">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 font-display tracking-tight">
                    iOS App <span class="text-gray-400">Categories</span>
                </h2>
                <div class="w-16 h-px bg-black mx-auto mb-6"></div>
                <p class="text-gray-500 max-w-2xl mx-auto text-base">
                    Proven expertise across every industry and use case.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-white border border-gray-200 hover:border-black transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-sm">Mobile shopping experiences with seamless checkout and Apple Pay integration.</p>
                    </div>
                </div>
                ...
                <div class="group bg-white border border-gray-200 hover:border-black transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-sm">Track workouts, nutrition, and health metrics with HealthKit integration.</p>
                    </div>
                </div>
                ...
                <div class="group bg-white border border-gray-200 hover:border-black transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-sm">Banking, budgeting, and investment platforms with enterprise-grade security.</p>
                    </div>
                </div>
                ...
                <div class="group bg-white border border-gray-200 hover:border-black transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-sm">E-learning platforms and interactive courses with offline support.</p>
                    </div>
                </div>
                ...
                <div class="group bg-white border border-gray-200 hover:border-black transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-sm">Connect users with feeds, messaging, and real-time notifications.</p>
                    </div>
                </div>
                ...
                <div class="group bg-white border border-gray-200 hover:border-black transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-black mb-2">Entertainment Apps</h3>
                        <p class="text-gray-500 text-sm">Streaming, gaming, and content platforms with premium experiences.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">Native Performance</h3>
                ...
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6">
                    ...
                    <p class="text-gray-500 text-sm">Face ID, Touch ID, and secure keychain integration.</p>
                </div>
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6">
                    <div class="w-12 h-12 bg-gray-100 flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">Offline Support</h3>
                    <p class="text-gray-500 text-sm">Seamless functionality without internet connection.</p>
                </div>
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6">
                    <div class="w-12 h-12 bg-gray-100 flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-500 text-sm">Engage users with timely and relevant notifications.</p>
                </div>
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6">
                    <div class="w-12 h-12 bg-gray-100 flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">Apple Pay Integration</h3>
                    <p class="text-gray-500 text-sm">Seamless payment processing for secure transactions.</p>
                </div>
                <div class="service-card bg-white border border-gray-200 hover:border-black p-6">
                    <div class="w-12 h-12 bg-gray-100 flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">App Store Optimization</h3>
                    <p class="text-gray-500 text-sm">We ensure your app gets discovered and downloaded.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-black mb-2">App Store Launch</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="pricing-card bg-white border border-gray-200 hover:border-black transition-all duration-300">
                    <div class="p-6 border-b border-gray-100">
                        ...
                        <div class="mt-4">
                            <span class="text-4xl font-bold text-black">$8k</span>
                    ...
                    <div class="p-6">
                        <ul class="space-y-3 mb-8">
                            ...
                            <li class="flex items-center gap-2 text-sm text-gray-600">✓ Basic UI/UX design</li>
                            <li class="flex items-center gap-2 text-sm text-gray-600">✓ App Store submission</li>
                ...
                <div class="pricing-card bg-white border-2 border-black hover:border-gray-400 transition-all duration-300 relative">
                    ...
                    <div class="p-6 border-b border-gray-100">
                        ...
                        <div class="mt-4">
                            <span class="text-4xl font-bold text-black">$15k</span>
                            <span class="text-gray-500">+</span>
                        </div>
                    </div>
                    <div class="p-6">
    ...
    <section class="py-20 md:py-28 bg-gray-50">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div>
                    <h3 class="font-semibold text-black mb-2">How long does iOS app development take?</h3>
                ...
                <div>
                    <h3 class="font-semibold text-black mb-2">Do you handle App Store submission?</h3>
                ...
                <div>
                    <h3 class="font-semibold text-black mb-2">Do you provide app marketing support?</h3>
                ...
                <div>
                    <h3 class="font-semibold text-black mb-2">What about Android version?</h3>
    ...
    <section class="py-20 bg-black">
        <div class="max-w-7xl mx-auto px-5 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 font-display tracking-tight">Ready to Build Your iOS App?</h2>
