...
<head>
    ...
    <title>iOS App Development - Alta Digital Agency</title>
...
<body class="bg-white font-sans">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <div class="inline-flex items-center gap-2 bg-emerald-500/20 backdrop-blur-sm text-emerald-300 px-4 py-2 mb-6 border border-emerald-500/30">
                        ...
                        <span class="text-sm font-semibold uppercase tracking-wider">iOS App Development</span>
                    </div>
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 font-display">
                        Build Premium 
                        <span class="bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent">iOS Apps</span>
                    </h1>
                    <p class="text-gray-300 text-lg mb-8 leading-relaxed">
                        Create stunning, high-performance iOS applications that deliver exceptional user experiences and drive business growth.
                    </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-navy-900 mb-4 font-display">Why Choose iOS for Your Business?</h2>
            <div class="w-20 h-1 bg-emerald-500 mx-auto"></div>
            <p class="text-gray-600 mt-6 max-w-2xl mx-auto">
                iOS users are among the most engaged, loyal, and high-value customers in the mobile market.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center p-6 border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-lg font-bold text-navy-900 mb-2">Premium Users</h3>
                <p class="text-gray-500 text-sm">iOS users spend more on apps and in-app purchases.</p>
            </div>
            <div class="text-center p-6 border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300">
                <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-lg font-bold text-navy-900 mb-2">Higher Security</h3>
                <p class="text-gray-500 text-sm">iOS offers robust security features and data protection.</p>
            </div>
            <div class="text-center p-6 border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300">
                <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-lg font-bold text-navy-900 mb-2">Better Performance</h3>
                <p class="text-gray-500 text-sm">Optimized hardware-software integration delivers smooth experiences.</p>
            </div>
            <div class="text-center p-6 border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300">
                <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-gray-500 text-sm">Access millions of iOS users worldwide through App Store.</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-50 py-16 md:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-navy-900 mb-4 font-display">Our iOS Tech Stack</h2>
                <div class="w-20 h-1 bg-emerald-500 mx-auto"></div>
                <p class="text-gray-600 mt-6 max-w-2xl mx-auto">
                    We use the latest technologies to build cutting-edge iOS applications
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 p-6 text-center">
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/swift/swift-original.svg" alt="Swift" class="w-16 h-16 mx-auto mb-3">
                    <h3 class="font-bold text-navy-900">Swift</h3>
                    <p class="text-xs text-gray-500 mt-1">Primary Language</p>
                </div>

                <!-- SwiftUI -->
                <div class="bg-white border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 p-6 text-center">
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/swift/swift-original.svg" alt="SwiftUI" class="w-16 h-16 mx-auto mb-3">
                    <h3 class="font-bold text-navy-900">SwiftUI</h3>
                    <p class="text-xs text-gray-500 mt-1">UI Framework</p>
                </div>

                <!-- Xcode -->
                <div class="bg-white border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 p-6 text-center">
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apple/apple-original.svg" alt="Xcode" class="w-16 h-16 mx-auto mb-3">
                    <h3 class="font-bold text-navy-900">Xcode</h3>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-navy-900 mb-4 font-display">Powerful iOS App Features</h2>
            <div class="w-20 h-1 bg-emerald-500 mx-auto"></div>
            <p class="text-gray-600 mt-6 max-w-2xl mx-auto">
                Everything you need to build a successful iOS application
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 border border-gray-200 hover:border-emerald-300 transition-all duration-300">
                ...
                <p class="text-gray-500 text-sm">Optimized for iPhone and iPad with smooth animations and fast loading.</p>
            </div>
            ...
            <div class="bg-white p-6 border border-gray-200 hover:border-emerald-300 transition-all duration-300">
                ...
                <p class="text-gray-500 text-sm">Face ID, Touch ID, and secure keychain integration for maximum security.</p>
            </div>
            ...
            <div class="bg-white p-6 border border-gray-200 hover:border-emerald-300 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold text-navy-900 mb-2">Offline Support</h3>
                <p class="text-gray-500 text-sm">Core Data and CloudKit integration for seamless offline functionality.</p>
            </div>
            ...
            <div class="bg-white p-6 border border-gray-200 hover:border-emerald-300 transition-all duration-300">
                ...
                <p class="text-gray-500 text-sm">Engage users with timely and relevant push notifications.</p>
            </div>
            ...
            <div class="bg-white p-6 border border-gray-200 hover:border-emerald-300 transition-all duration-300">
                ...
                <p class="text-gray-500 text-sm">Track user behavior and app performance with comprehensive analytics.</p>
            </div>
            ...
            <div class="bg-white p-6 border border-gray-200 hover:border-emerald-300 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold text-navy-900 mb-2">Apple Pay Integration</h3>
                <p class="text-gray-500 text-sm">Seamless payment processing with Apple Pay for secure transactions.</p>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-300 transition-all duration-300 group">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-gray-500 text-sm">Mobile shopping experiences with seamless checkout.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-300 transition-all duration-300 group">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-gray-500 text-sm">Connect users with feeds, messaging, and sharing features.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-300 transition-all duration-300 group">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-gray-500 text-sm">Track workouts, nutrition, and health metrics.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-300 transition-all duration-300 group">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-gray-500 text-sm">Banking, budgeting, and investment platforms.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-300 transition-all duration-300 group">
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-navy-900 text-lg mb-2">Entertainment Apps</h3>
                        <p class="text-gray-500 text-sm">Streaming, gaming, and content platforms.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-navy-900 mb-4 font-display">Our iOS Development Process</h2>
            <div class="w-20 h-1 bg-emerald-500 mx-auto"></div>
            <p class="text-gray-600 mt-6 max-w-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg font-bold text-navy-900 mb-2">App Store Deployment</h3>
                <p class="text-gray-500 text-sm">Submission and launch support</p>
            </div>
        </div>
    </div>
    ...
    <div id="pricing" class="bg-gray-50 py-16 md:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-navy-900 mb-4 font-display">iOS App Development Pricing</h2>
                <div class="w-20 h-1 bg-emerald-500 mx-auto"></div>
                <p class="text-gray-600 mt-6 max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white border border-gray-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300">
                    <div class="p-6 border-b border-gray-100">
                        <h3 class="text-xl font-bold text-navy-900">Basic iOS App</h3>
                ...
                <div class="bg-white border-2 border-emerald-500 hover:shadow-xl transition-all duration-300 relative">
                    ...
                    <div class="p-6 border-b border-gray-100">
                        <h3 class="text-xl font-bold text-navy-900">Professional iOS App</h3>
                ...
                <div class="bg-white border border-gray-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300">
                    <div class="p-6 border-b border-gray-100">
                        <h3 class="text-xl font-bold text-navy-900">Enterprise iOS App</h3>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-navy-900 mb-4 font-display">iOS App Success Stories</h2>
            <div class="w-20 h-1 bg-emerald-500 mx-auto"></div>
            <p class="text-gray-600 mt-6 max-w-2xl mx-auto">
                See how we've helped businesses succeed on the App Store
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="group bg-white overflow-hidden border border-gray-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-5">
                    <h3 class="font-bold text-navy-900 mb-2">FitTrack iOS App</h3>
                    <p class="text-gray-500 text-sm mb-3">500K+ downloads, 4.9★ rating</p>
            ...
            <div class="group bg-white overflow-hidden border border-gray-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-5">
                    <h3 class="font-bold text-navy-900 mb-2">StyleStore iOS App</h3>
                    <p class="text-gray-500 text-sm mb-3">312% increase in mobile sales</p>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-1">
                            <span class="text-yellow-400">★★★★★</span>
            ...
            <div class="group bg-white overflow-hidden border border-gray-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-5">
                    <h3 class="font-bold text-navy-900 mb-2">StreamFlix iOS App</h3>
                    <p class="text-gray-500 text-sm mb-3">1M+ active users, featured by Apple</p>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-1">
                            <span class="text-yellow-400">★★★★★</span>
                            <span class="text-xs text-gray-500">(5.0)</span>
    ...
    <div class="bg-gray-50 py-16 md:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div>
                    <h3 class="font-semibold text-navy-900 mb-2">How long does iOS app development take?</h3>
                ...
                <div>
                    <h3 class="font-semibold text-navy-900 mb-2">Do you handle App Store submission?</h3>
                    <p class="text-gray-500 text-sm">Yes, we manage the entire App Store submission process and ensure compliance with Apple's guidelines.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Absolutely! We specialize in API integrations with backend services and third-party platforms.</p>
                </div>
                <div>
                    <h3 class="font-semibold text-navy-900 mb-2">Do you provide app marketing support?</h3>
                    <p class="text-gray-500 text-sm">Yes, we offer ASO (App Store Optimization) and marketing consultation to maximize your app's visibility.</p>
                </div>
                <div>
                    <h3 class="font-semibold text-navy-900 mb-2">What about Android version?</h3>
                    <p class="text-gray-500 text-sm">We can build Android versions using native Kotlin or cross-platform solutions like Flutter.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-emerald-600 to-emerald-500 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 font-display">Ready to Build Your iOS App?</h2>
            <p class="text-emerald-100 mb-8 max-w-2xl mx-auto">
                Let's turn your app idea into a successful iOS application that users will love.
            </p>
